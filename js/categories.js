...
getApiData("https://www.themealdb.com/api/json/v1/1/categories.php").then(
  (data) => {
...
function displayCategoriesData() {
  ...
  for (i = 0; i < lCatigories.length; i++) {
    cartona += `<div class="col-md-4" id="tessst">
            <div class="card category-card" id=${lCatigories[i].strCategory}  >
                <img src=${
                  lCatigories[i].strCategoryThumb
                } class="card-img my-img" >
                <h3>${lCatigories[i].strCategory
                  .split(" ")
                  .slice(0, 1)
                  .join(" ")}</h3>
            </div>
    ...
    item.addEventListener("click", () => {
      getApiData(
        ...
        for (i = 0; i < measures.length; i++) {
          mContainer += 
          `<div class=" strMeasuree   fw-normal " >
